...
class ShipTest < Minitest::Test
  ...
  #   ship = Ship.new
  #   ship.ship_1_coordinate_validation(user_input)"A1 A2 A3 A4")
  #   input = ship.ship_1_input_too_small_or_large
  #   output = "You entered too many characters. Enter your choice as a two digit coordinate, a space, and then your final two digit coordinate, then hit enter. Example:
  #   D2 D3
  #   or
  ...
  #   ship = Ship.new
  #   ship.ship_1_coordinate_validation(user_input)"A1 A2")
  ...
  #
  #
  # def test_returns_error_if_user_inputs_inboard.valid_coordinates
  #   ship = Ship.new
  #   ship.ship_1_coordinate_validation(user_input)"A1 F5")
  #   input = ship.ship_1_has_board.valid_coordinates
  #   output = "You entered a coordinate that is outside the bounds of this board.\nEnter your coordinates again."
  #
  #   assert_equal output, input
  # end
  #
  # def test_chooses_board.valid_coordinates_again
  #   ship = Ship.new
  #   ship.ship_2("A1 GO CU")
  #   input = ship.ship_2_has_board.valid_coordinates
  #   output = "You entered a coordinate that is outside the bounds of this board.\nEnter your coordinates again."
  #   assert_equal output, input
  # end
  #
