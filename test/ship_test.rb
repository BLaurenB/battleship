...
#------------------------
#computer chooses. Also need to test that ship choice and ship sinking can affect the board
#------------------------

  def test_computer_can_select_ship_1_coordinates
    ship = Ship.new
    board = Board.new
    ship.computer_ship_1_choice

    assert ship.computer_ship_1_choice.length == 2
  end

  def test_computer_can_select_ship_2_coordinates
    ship = Ship.new
    board = Board.new
    refute ship.computer_ship_2_choice == ship.computer_ship_1_choice
  end

  def test_computer_does_not_overlap_ships
    ship = Ship.new
    ship.computer_ship_2_choice
    ship.computer_ship_1_choice
